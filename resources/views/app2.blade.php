...
<header class="bg-white/35 shadow-black-xs backdrop-blur-md shadow-md sticky top-0 z-50 py-4 px-6 flex items-center justify-between">
  ...
  <div class="flex justify-center">
    <a href="/" class="block">
      <img src="{{url('media/logo1dark.jpeg')}}"  alt="app2 Logo" class="h-20 sm:h-28 md:h-36 lg:h-40 w-auto">
    </a>
  </div>
...
<div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 mt-10 min-h-[600px] lg:min-h-[700px]">
  <img src="{{url('media/tetsted.jpg')}}" class="absolute inset-0 -z-10 w-full h-full object-cover object-center md:object-right" />
  <img src="{{ url('media/flashbattext.gif') }}" alt="FlashBat Text" class="absolute top-10 left-1/2 transform -translate-x-1/2 z-10 w-[80%] max-w-5xl pointer-events-none" />
    ...
    <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      ...
      <dl class="mt-10 pt-56 sm:pt-64 lg:pt-80 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
        <div class="flex flex-col-reverse gap-1">
          ...
          <dd class="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-white">12</dd>
        </div>
        <div class="flex flex-col-reverse gap-1">
          <dt class="text-base/7 text-black">Orders</dt>
          <dd class="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-white">300+</dd>
        </div>
        <div class="flex flex-col-reverse gap-1">
          <dt class="text-base/7 text-black">Hours per week</dt>
          <dd class="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-black">40</dd>
        </div>
        <div class="flex flex-col-reverse gap-1">
          <dt class="text-base/7 text-black">Paid time off</dt>
          <dd class="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-black">Unlimited</dd>
        </div>
      </dl>
    </div>
  </div>
